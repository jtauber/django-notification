...
DEFAULT_NOTIFICATIONS_ON_SITE = getattr(settings, "DEFAULT_NOTIFICATIONS_ON_SITE", True)
...
class NoticeManager(models.Manager):
    ...
    def unseen_for(self, recipient, **kwargs):
        """
        returns unseen notices for given user (dose not mark them seen)
        """
        return self.notices_for(recipient, unseen=True, **kwargs)
...
class Notice(models.Model):
    ...
    on_site = models.BooleanField(_("on site"), default=DEFAULT_NOTIFICATIONS_ON_SITE)
...
def send_now(users, label, extra_context={}, on_site=True, sender=None):
    """
