...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NoticeType.locked'
        db.add_column('notification_noticetype', 'locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeType.locked'
        db.delete_column('notification_noticetype', 'locked')
